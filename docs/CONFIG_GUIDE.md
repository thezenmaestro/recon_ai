...
For common tasks (adding desks, switching sources, enabling FX lookups) and the pre-flight validation checklist, see [CONFIG_QUICK_START.md](CONFIG_QUICK_START.md).
